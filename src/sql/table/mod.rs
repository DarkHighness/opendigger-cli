...
pub use change_request::{
    ...
    CHANGE_REQUESTS_TABLE_NAME, CHANGE_REQUESTS_TABLE_SCHEMA,
    CHANGE_REQUEST_RESPONSE_TIME_TABLE_NAME, CHANGE_REQUEST_RESPONSE_TIME_TABLE_SCHEMA,
    CHANGE_REQUEST_RESOLUTION_DURATION_TABLE_NAME, CHANGE_REQUEST_RESOLUTION_DURATION_TABLE_SCHEMA,
    CHANGE_REQUEST_AGE_TABLE_NAME, CHANGE_REQUEST_AGE_TABLE_SCHEMA,
};
