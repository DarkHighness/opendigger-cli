...
impl StorageTable for ActivityTable {
    fn name(&self) -> &str {
        "Activity"
    }
    ...
    pub async fn build(
        ...
        let metric = match r#type {
            crate::api::Type::Repository => {
                crate::api::Metric::Repo(crate::api::RepoMetric::Activity)
            }
            crate::api::Type::User => crate::api::Metric::User(crate::api::UserMetric::Activity),
        };
